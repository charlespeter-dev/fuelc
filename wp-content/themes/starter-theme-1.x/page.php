...
if ($page_got_passwd) {
    ...
    if (in_array($timber_post->post_name, ['community', 'live', 'market-research-cloud', 'contact', 'request-a-demo', 'solutions', 'about-us', 'fc-exchange', 'ignition', 'customer-stories', 'become-a-partner'])) {
